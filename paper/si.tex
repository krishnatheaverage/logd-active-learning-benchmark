...
All code is released (concept DOI 10.5281/zenodo.20764583). The experiments are
reproduced by \texttt{src/05\_active\_learning/}: \texttt{real\_data.py} (baseline),
\texttt{real\_al.py} ($f$-element AL), \texttt{lipo\_al.py} (Lipophilicity AL),
\texttt{al\_calibration.py} (calibration), \texttt{prospective.py} (prospective
validation). The $f$-element source data are from Liu et al.\ (cited); the
Lipophilicity set is from MoleculeNet.
